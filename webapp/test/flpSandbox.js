		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "customerblockscreen",
									"targetURL": "#customerblockscreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"customerblockscreen-display": {
								"semanticObject": "customerblockscreen",
								"action": "display",
								"description": "customerblockscreen",
								"title": "customerblockscreen",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.itsgroup.brz.customerblockscreen",
									"url": sap.ui.require.toUrl("com/itsgroup/brz/customerblockscreen")
								}
							}
						}
					}
